...
function genesis_do_footer() {
	...
	/**$creds_text     = sprintf( '[footer_childtheme_link]' );**/
	/**$creds_text = sprintf( '[<a href="http://www.studiopress.com/themes/adorable" title="Adorable Child Theme">Adorable Theme</a>]');**/
	$creds_text = '<a href="http://www.studiopress.com/themes/adorable" title="Adorable Child Theme">Adorable Theme</a>';
